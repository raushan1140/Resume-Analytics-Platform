...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      {/* Architecture Diagram - Moved here to appear right after Hero */}
      {showArchitecture && (
        <section ref={architectureRef} className="px-8 py-16 max-w-6xl mx-auto animate-fadeIn">
      ...
      <footer className="border-t border-slate-700/50 px-8 py-8 text-center text-slate-400 text-sm">
        <p>© 2026 Raushan Raj. All rights reserved.</p>
      </footer>
    </div>
  );
}
